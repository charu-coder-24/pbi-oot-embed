...
const CategoryModal = ({ updateCategory, addNewCategory, selectedButton, categoryObj, onSave, onClose }) => {
    ...
    const setSubcategoryStatus = (value) => {
        ...
        if (selectedButton === "report") {
            ...
            const newReports = reports.filter(report => !reportsCopy.some(existingReport => existingReport.id === report.id));
        ...
        categoryObj = { ...categoryObj, subCategories: subCategoryObjCopy, reports: reportsCopy, error: error }
