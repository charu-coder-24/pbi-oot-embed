...
import SupplyChainLanding from "../SupplyChainLanding/SupplyChainLanding";
  ...
  const categoryDescription = [
    {
      category: "executive",
      purpose:
        "To provide a comprehensive overview for executive leadership on key performance indicators (KPIs) across the organization. The dashboard should help executives make informed strategic decisions by displaying trends and performance metrics.",
      dataUsed: {
        dataSource:
          "Financial reports, market data, internal KPIs, project milestones.",
        keyFields: [
          "Revenue",
          "Profit Margins",
          "Market Share",
    ...
    },
    {
      category: "sales",
      purpose:
        "To analyze and compare sales performance across regions, channels, and products. This dashboard aims to inform and optimize sales strategies.",
      dataUsed: {
      ...
      features: ["Option to drill down into regional and product-level data."],
      businessQuestionsAnswered: [
    ...
    },
    {
      category: "finance",
      purpose:
        "To provide a detailed view of the financial health of the organization. Focus on key metrics like revenue, cost, cash flow, and profitability.",
      dataUsed: {
        dataSource:
          "Financial statements, internal cost reports, project accounting.",
        keyFields: [
          "Revenue",
    ...
    },
    {
      category: "marketing",
      purpose:
        "To track and analyze the effectiveness of marketing campaigns and strategies. The dashboard should provide insights to optimize campaign performance and customer segmentation.",
      dataUsed: {
        dataSource:
          "Marketing automation tools, social media analytics, customer surveys.",
        keyFields: [
          "Campaign ID",
          "Customer Segment",
          "Marketing Channel",
    ...
    },
    {
      ...
      purpose:
        "To optimize supply chain efficiency and monitor key metrics like inventory, supplier performance, and logistics. Provide insights to improve order fulfillment and reduce costs.",
      dataUsed: {
        dataSource:
          "Inventory management systems, supplier databases, logistics reports.",
        keyFields: [
          "Supplier",
          "Product",
          "Inventory Levels",
    ...
    },
    {
      ...
      purpose:
        "To monitor and improve manufacturing processes and operational efficiency. Focus on key metrics such as OEE (Overall Equipment Effectiveness), production output, and quality.",
      dataUsed: {
      ...
      <main className="main-content">
          ...
          <div className="dashboard">
              ...
              <ul>
                ...
                <li>
                  ...
                  <div style={{ fontWeight: "bold", fontSize: "18px" }}>
                    {selCategory?.dataUsed.keyFields.join(", ")}
                  </div>
                </li>
              </ul>
            </section>
            ...
            <section className="section">
              ...
              <ul>
                {selCategory?.businessQuestionsAnswered.map(
                  (question, index) => (
